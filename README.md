...
**与专业版的区别**
**青春版取消了分发逻辑(即:只有一个root用户不能新增其他用户,只有1个令牌,令牌可刷新)，专注渠道聚合，更加轻量化**
**其余功能完全一致，并与专业版同步更新**
...
Shell API 停止出售
为避免中转服务商的同质化加剧，导致相关市场越来越内卷，利润越来越低，更进一步是可能导致业务被迫中断。@William 前瞻性地与 Shell API 协商，每月支付项目组一定款项，Shell API 不再对外出售或增加授权实例。
Shell API 未来会将重心放在服务目前已有的客户上
① 开发原项目可能不提供的新功能（长期）
② 合并来自原项目的更改（长期）
③ 提供完善的使用文档（长期）
④ 重构前端（近期）
...
⑥ “套餐”功能的测试和上线（近期）
...
鉴于多机部署可能需要多实例授权，自本公告发出起七日内，仍允许已购买用户增加授权（≤3 实例）
...
<img width="667" alt="image" src="https://github.com/akl7777777/one-api/assets/135022988/866dd5fd-e2ae-4bc8-99ac-2beea0e1449e">
